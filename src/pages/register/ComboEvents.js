...
const ComboEvents = () => {
  ...
  const IData = {
    ...
    contact: "",
    about:
      "Experience an electrifying DJ Night at our college function, featuring pulsating beats, vibrant lights, and an atmosphere brimming with energy that promises an unforgettable evening of music and dance.",
    teamSize: 1,
    eventFee: 150,
  };
  return (
