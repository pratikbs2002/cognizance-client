...
export default function Payment() {
    return (
        <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", width: "100%", paddingLeft: "30px", fontWeight: "500", fontSize: "30px", paddingTop: "80px", paddingBottom: "50px" }}>Payment | ₹ 500 </div>
            <div style={{ display: "flex", width: "100%", justifyContent: "center" }}>
                <div className='part1' style={{ borderRight: "2px solid #282b35", display: "flex", width: "50%", alignItems: "center", flexDirection: "column" }}>
                    ...
                    <div className='body' style={{ paddingTop: "100px", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", width: "100%" }}>
                        <div style={{ width: "100%", paddingLeft: "100px", display: "flex", flexDirection: "column", gap: "10px" }}>
