...
const NonTechEvents = (props) => {
  const data = [
    ...
    },
    {
      ...
      description: "",
      about:
        "Express your inner voice in the form of a rap. Let the others see the world through your eyes in your own words.",
      task: [
    ...
    },
    {
      ...
      description:
        "Enhance your expertise in cable and wire testing techniques through our comprehensive workshop, covering essential methods for accurate diagnostics and quality assurance.",
      about:
        "The CS2 Tournament is an exciting gaming event organized as part of Cognizance 23, the annual techfest of our esteemed institution. This tournament aims to bring together gaming enthusiasts, showcase their skills, and promote a spirit of healthy competition within the gaming community.",
      task: [
