...
export default function ComboContainer() {
  ...
  const IData = {
    ...
    contact: "",
    about:
      "Experience an electrifying Musical Night at our college function, featuring pulsating beats, vibrant lights, and an atmosphere brimming with energy that promises an unforgettable evening of music and dance.",
    teamSize: 1,
    eventFee: 1000,
    eventType: "WORKSHOP",
  };
      ...
      >
        ...
        >
          ...
          >
            <div>Note:</div>
            <div>
              Act now! Register your squad before <b>January 15, 2024</b>, and
              seize the exclusive benefits of our limited-time combo offer!
            </div>
          </div>
        </Container>
        <Container padding={0} margin={0} className="events-combo" maxW={"90%"}>
          ...
          >
            ...
            >
              <div>
                Take advantage of our exclusive combo offer! Click on the cards
                above to select 1 or 2 tech events. Remember to register your
                squad for all selected events to proceed to payment and unlock
          ...
          >
            ...
            <Button
              ...
              isDisabled={
                ...
                isAllEventTeamRegistered.length !== priceDetails.length
              }
            >
              Pay
            </Button>
